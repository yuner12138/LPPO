...
class PDTSPTest_Vector_select_best:
    def __init__(self,
                 env_params,
                 model_params,
                 tester_params):
    ...
    def run(self):
        ...
        best_aug_score_AM = AverageMeter()

        test_num_episode = self.tester_params['test_episodes']


        if self.tester_params['test_data_load']['enablepkl']:
            self.env.use_pkl_saved_problems_OURs(self.tester_params['test_data_load']['filenamepkl'], test_num_episode)
        ...
        while episode < test_num_episode:
            ...
            if not self.tester_params['EAS_params']['enable']:
                ...
                while iter < 2:
                    ...
                    print("score {},aug_score {}".format(score,aug_score))
            ...
            score_AM.update(max_avg_obj, batch_size)
            aug_score_AM.update(max_aug_obj, batch_size)
    ...
    def _test_one_batch(self, batch_size):
        ...
        with torch.no_grad():
            ...
            if self.tester_params['greedy_select_block']:
                ...
                self.env.load_problems(batch_size, self.block_sample*self.k, aug_factor)
