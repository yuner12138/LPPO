...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': './result_old/MLP_AVG_100_950',  # directory path of pre-trained model and log files saved.
        'epoch': '950',  # epoch version of pre-trained model to laod.
    },
    'validation_data_load': {
        'enable': False,
        'filename': '../datasets/PDtsp100_valid_seed1233.pkl'
    },
}
