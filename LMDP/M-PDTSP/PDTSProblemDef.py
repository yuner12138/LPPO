...
# def get_dataset_problem_OURS(file_path, batch_size,begin_idx, aug_type='8'):
#     depot_size = 1
...
def get_random_problems_old(batch_size, problem_size):
