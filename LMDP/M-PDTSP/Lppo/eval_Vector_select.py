...
# from PDTSPTest_Vector_ben import PDTSPTest_Vector_ben as Tester
...
tester_params = {
    ...
    'amp_inference': False,
    'model_load': {
        'path': './result_old/mpdtsp100',  # directory path of pre-trained model and log files saved.
    ...
    'test_data_load': {
        ...
        'enablecvs': True,
        'filenamecvs': './pdtsp_benchmark/PDTSP101P1.csv',
    },
